...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1091-erd-s-problem-1091-498d5541-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1091"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1091-erd-s-problem-1091-498d5541-v1",
      "problem_contract_sha256": "991d1ea49f81cf65313cc2350c447114793d74cd959e2a849bf1d131a557a312",
      "problem_id": "problem:um-ep-1091-erd-s-problem-1091-498d5541",
      "route_id": "route:um-ep-1091-erd-s-problem-1091-498d5541-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1091-erd-s-problem-1091-498d5541-source-fidelity-01",
      "graph_id": "graph:um-ep-1091-erd-s-problem-1091-498d5541-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1091-erd-s-problem-1091-498d5541-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1091-erd-s-problem-1091-498d5541-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be a $K_4$-free graph with chromatic number $4$. Must $G$ contain an odd cycle with at least two diagonals? More generally, is there some $f(r)\\to \\infty$ such that every graph with chromatic number $4$, in which every subgraph on $\\leq r$ vertices has chromatic number $\\leq 3$, contains an odd cycle with at least $f(r)$ diagonals?"
          },
          "statement_sha256": "b762db42fecbad2ddb7001bb36da6f035c312441bf855174668656dccc49ed98"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1091-erd-s-problem-1091-498d5541-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1091-erd-s-problem-1091-498d5541-root",
      "route_id": "route:um-ep-1091-erd-s-problem-1091-498d5541-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1091-a3b15dff55ef",
        "url": "https://www.unsolvedmath.com/problems/EP-1091"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
